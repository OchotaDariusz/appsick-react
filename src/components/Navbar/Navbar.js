          ...
          <div className="d-flex justify-content-end">
                    <span className="navbar-text">
                        <Link className="nav-link float-start" to={'/register'}>
                            <button className="btn btn-sm mx-2 my-1 rounded-pill text-white fs-5 px-3"
                                    style={{backgroundColor: "#465969"}}>Registration</button>
                        </Link>
                        <Link className="nav-link float-start" to={'/login'}>
                            <button className="btn btn-sm mx-2 my-1 rounded-pill text-white fs-5 px-3"
                                    style={{backgroundColor: "#465969"}}>Login</button>
                        </Link>
                      <Link className="nav-link float-start" to={'/login'} onClick={logout}>
                      <button className="btn btn-sm mx-2 my-1 rounded-pill text-white fs-5 px-3"
                              style={{backgroundColor: "#465969"}} onClick={logout}>Logout</button>
                      </Link>
                    </span>
          </div>
        </div>
