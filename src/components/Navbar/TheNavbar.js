...
export default function TheNavbar() {
  ...
  return (
    <>
      <nav className="navbar navbar-expand-md bg-light  flex-nowrap rounded-4 green-shadow bg-opacity-75">
        <div className="container-fluid">
          ...
          >
            {!auth.email ? (
              <div className="navbar-nav container"></div>
            ) : (
              <div className="navbar-nav container">
                <div className="row flex-nowrap align-items-center">
                  <div className="col fs-4  mx-4 nvbr">
                    ...
                    >
                      <img
                        className="float-start img-fluid mx-1"
                        src={visit}
                        alt="visit"
                        style={{ height: 60 }}
                      />
          ...
          {!auth.email ? (
            <div className="w-100">
              <div className="btnx collapse navbar-collapse nav-link d-flex justify-content-end align-items-center">
                <div
            ...
            <>
              <div className="w-25">
                <div className="container collapse navbar-collapse nav-link d-flex justify-content-end align-items-center">
                  <Link
              ...
              <div className="w-100">
                <div className="collapse navbar-collapse nav-link d-flex justify-content-end align-items-center">
                  <div className="justify-content-end">
                    <div className="collapse navbar-collapse nav-link flex-nowrap d-inline-flex">
                      <div
