                ...
                <div className="col-8">
                    <div className="row align-content-between">
                        <div className="col-2">
                            ...
                            <Link className="fs-4 nav-link d-flex align-items-center px-3" to={'/about'}>
                                <img src={User} alt='user' style={{height: "30px"}} className="me-2"/>
                                About us
                            </Link>

                            <div className="fs-4">
                                <Link className="nav-link d-flex align-items-center px-3" to={'/credits'}>
                        ...
                        <div className="col-auto align-content-end">
                            ...
                            <img src={footer} alt='footer' style={{height: "250px", width: "1100px"}}   className="px-5"/>
                        </div>
