          ...
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-sm-4 ">
                ...
                <div
                  className="btnx fs-3 text-black border border-dark border-2
                ...
                >
                  <a
                    href={`${process.env.REACT_APP_BACKEND_HOST}/oauth2/authorization/google`}
                  >
                    Login with Google
                  </a>
                ...
                <Register setRegisterModalShow={props.setRegisterModalShow} />
              </div>
            </div>
          </div>
        </Modal.Body>
