    ...
    <div>
            ...
            <div className="anim">
              ...
              <div className="anim-element hidden">
                ...
                <div className="fs-3 text-center">
                  With our help you can make an appointment quickly and safely.
                  <br />
                </div>
              </div>
              <div className="anim-element hidden">
            ...
            <div className="anim">
              ...
              <div className="anim-element hidden">
                ...
                <div className="fs-1 px-4 text-center">
                  Welcome to App Sick, where you can <br />
          ...
          <div className="anim">
            ...
            <div className="anim-element hidden">
              <div className="fs-1 px-4 text-center">
                ...
                <br />
                <br />
                AppSick is a promising startup <br />
                in the private health sector in Poland.
                <br />
                <br />
                Our ambition is to deliver the most accessible and convenient{" "}
                <br /> systems for private healthcare market.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="anim">
          <div className="anim-element hidden">
            <div className="fs-1 px-4 text-center">
              ...
              <br />
              <br />
              This means a commitment to excellent customer experience,
              <br /> through great service and value.
            </div>
          </div>
          <div className="anim-element hidden">
            <div></div>
      ...
      <section>
        <div className="anim">
          <div className="anim-element hidden">
            <div className="fs-1 text-center">
              Our application is aimed at coordination of private healthcare
              companies.
              <br />
            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                ...
                <div className="carousel-caption d-none d-md-block text-dark text-slider text-center">
                  ...
                  <div className="fs-5">
                    Polecam pediatra miły i kompetentny. Nie ma presji czasu a
                    więc mozna przegadać wszystko z czym sie przyszło.
                  </div>
                </div>
              </div>
              <div className="carousel-item">
                ...
                <div className="carousel-caption d-none d-md-block text-dark text-slider text-center">
                  ...
                  <div className="fs-5">
                    Bardzo udana współpraca. Cena nie zniechęca, zwłaszcza że
                    korzystam średnio raz na 3-4 miesiące.
                  </div>
                </div>
              </div>
              <div className="carousel-item">
                ...
                <div className="carousel-caption d-none d-md-block text-dark text-slider text-center">
                  ...
                  <div className="fs-5">
                    Idealne w okresie grypowym. Bez problemu uzyskałam receptę i
                    L4. Dziekuję za pomoc!
                  </div>
                </div>
              </div>
            </div>
