            ...
            <div className="container-fluid col-lg-6 col-md-12 col-sm-12
             mx-auto rounded-5 bg-light text-dark  mt-3 green-shadow">
                <div className="row justify-content-center d-inline">
                    <div className="col fs-1 text-center">Contact Page</div>
                    <div className="row">
                        <div className="col-4">
                            <img className="border rounded-5 " src={tracz} style={{height: 250}}
                                 alt="tracz"/>
                        </div>
                        <div className="col-8 fs-2 d-inline">
                            ...
                            <div className="d-inline-flex me-3 align-items-center">
                                ...
                                <Link src="https://github.com/szopszop">https://github.com/szopszop</Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-4">
                            <img className="border rounded-5 " src="https://dinoanimals.pl/wp-content/uploads/2014/08/Rokselana_7.jpg" style={{height: 250}}
                                 alt="tracz"/>
                        </div>
                        <div className="col-8 fs-2 d-inline">
                            <br/>
